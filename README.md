...
- **[docs/TRADEOFFS.md](./docs/TRADEOFFS.md)** — **Deliberate trade-offs:** at least three (here, six) places where the implementation was simplified or scoped down, with rationale and what you give up.
